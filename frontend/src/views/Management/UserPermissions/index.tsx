            ...
            <Table size="small">
              ...
              >
                <TableRow>
                  ...
                  <TableCell align="center">
                    {tr('userPermissions.maintenanceProject.write')}
                  </TableCell>
                  <TableCell align="center">
                  ...
                  <TableCell align="center">{tr('userPermissions.palmGrouping.write')}</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                {localUserPermissions.map((user) => (
                  <TableRow key={user.userId} hover={true}>
                    ...
                    <TableCell align="center">
                      <Checkbox
                        checked={hasPermission(user, 'maintenanceProject.write')}
                        disabled={user.isAdmin}
                        onClick={() => handlePermissionChange(user, 'maintenanceProject.write')}
                      />
                    </TableCell>
                    <TableCell align="center">
                      <Checkbox
                    ...
                    <TableCell align="center">
                      <Checkbox
                        checked={hasPermission(user, 'palmGrouping.write')}
                        disabled={user.isAdmin}
                        onClick={() => handlePermissionChange(user, 'palmGrouping.write')}
                      />
                    </TableCell>
                  </TableRow>
                ))}
