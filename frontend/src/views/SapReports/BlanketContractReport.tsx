      ...
      <DataTable
        ...
        columns={{
          ...
          totalDebit: {
            ...
            type: 'currency',
            helpTooltip: tr('sapReports.blankeContracts.totalDebitHelp'),
          },
          totalCredit: {
            ...
            type: 'currency',
            helpTooltip: tr('sapReports.blanketContracts.totalCreditHelp'),
          },
          totalActuals: {
            ...
            align: 'right',
            type: 'currency',
            helpTooltip: tr('sapReports.blanketContracts.totalActualsHelp'),
          },
        }}
      />
    </>
