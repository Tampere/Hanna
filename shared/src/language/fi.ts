export const fi = {
  ...
  'projectForm.formTitle': 'Hankkeen tiedot',
  ...
  'projectObject.chartTabLabelDisabled': 'Kohteelta puuttuu SAP-rakenneosan tunniste.',
  'projectObject.chartTablLabelNotStarted': 'Kohde ei ole vielä alkanut.',
