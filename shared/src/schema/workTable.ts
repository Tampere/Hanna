...
export const workTableRowSchema = z.object({
  ...
  projectPublicDescription: z.string().nullable(),
  objectDescription: z.string().nullable(),
  objectPublicDescription: z.string().nullable(),
...
export const templateColumns: Record<ReportTemplate, WorkTableColumn[]> = {
  ...
  basic: [
    'projectLink',
    'projectDescription',
    'projectPublicDescription',
    'projectDateRange',
    'sapProjectId',
    'objectName',
    'objectDescription',
    'objectPublicDescription',
    'objectDateRange',
    'sapWbsId',
    'operatives',
  ],
